...
export type DispatchThreadCommandInput = Extract<
...
export const dispatchThreadCommand: (input: DispatchThreadCommandInput) => CommandEffect =
  Effect.fn("EnvironmentCommands.dispatchThreadCommand")(function* (input) {
