...
import {
  ...
  type DispatchThreadCommandInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    dispatchCommand: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:dispatch-command",
      execute: (input: DispatchThreadCommandInput) => dispatchThreadCommand(input),
      scheduler,
      concurrency,
    }),
