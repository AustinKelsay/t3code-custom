...
const LEGACY_BASELINE = new Map<string, number>([
  ...
  ["apps/server/src/orchestration/decider.projectScripts.test.ts", 18],
  ...
  ["apps/server/src/orchestration/Layers/ProviderCommandReactor.test.ts", 79],
  ["apps/server/src/orchestration/Layers/ProviderRuntimeIngestion.test.ts", 33],
  ["apps/server/src/orchestration/Layers/QueuedTurnDrainReactor.test.ts", 28],
  ["apps/server/src/orchestration/Layers/ThreadDeletionReactor.test.ts", 2],
  ["apps/server/src/orchestration/projector.test.ts", 26],
